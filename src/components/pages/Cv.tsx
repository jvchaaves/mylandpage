...
const stack = [
  { area: "ai", items: "Python · PyTorch · LangChain · LLMs · Computer Vision · Whisper" },
  { area: "backend", items: "TypeScript · Node.js · Express · FastAPI · PostgreSQL · Redis · RabbitMQ" },
      ...
      <section className="mb-12">
        ...
        <dl className="space-y-2">
          {stack.map(({ area, items }) => (
            <div key={area} className="flex flex-col gap-1 sm:flex-row sm:gap-4">
