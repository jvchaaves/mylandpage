  ...
  return (
    <footer className="bg-[#0a0a0a] px-6 pb-8 pt-12">
      <div className="mx-auto max-w-6xl">
        <div className="h-px w-full bg-gradient-to-r from-[#C8FF00]/40 via-[#1F1F1F] to-transparent" />
        ...
        <div className="flex flex-col items-center justify-between gap-6 pt-8 sm:flex-row">
          ...
          <p className="font-display text-sm font-medium text-[#F0EDE8]/40">
            jv.<span className="text-[#C8FF00]/40">chaves</span>
          </p>
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full border border-white/10 text-[#8B8680] transition-all duration-200 hover:border-[#C8FF00]/40 hover:text-[#C8FF00]"
              >
                {link.icon}
              </a>
            ))}
