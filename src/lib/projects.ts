...
export const projects: Project[] = [
  ...
  },
  {
    slug: "zoox-agents",
    name: "Zoox Agents",
    tagline: "Sistema de Q&A sobre documentos com agentes CrewAI",
    description:
      "Zoox Agents é um sistema de Q&A sobre documentos que utiliza agentes CrewAI com RAG. Os usuários fazem upload de arquivos em múltiplos formatos (PDF, imagens, documentos) e o sistema processa tudo com OCR inteligente via Gemini Vision.\n\nA busca vetorial é realizada via ChromaDB com isolamento por sessão, garantindo que cada usuário tenha seu próprio espaço de busca sem interferência de outros documentos. O agente RAG é configurável via YAML, permitindo ajustes finos no comportamento de busca e geração.\n\nO sistema suporta processamento em batch paralelo para OCR de documentos grandes, otimizando o tempo de indexação e permitindo que o usuário comece a fazer perguntas rapidamente após o upload.",
    howItWorks:
      "O usuário faz upload de um documento e o sistema detecta automaticamente se OCR é necessário. Para imagens e PDFs escaneados, o Gemini Vision processa os documentos em batches paralelos, extraindo texto com alta precisão mesmo de documentos com formatação complexa.\n\nO texto extraído é indexado no ChromaDB com isolamento por sessão — cada sessão do usuário tem sua própria coleção vetorial, garantindo privacidade e relevância nos resultados. Os chunks são otimizados para maximizar a qualidade da busca semântica.\n\nQuando o usuário faz uma pergunta, o agente CrewAI RAG busca os chunks mais relevantes na coleção da sessão e gera uma resposta contextualizada, citando as partes do documento que fundamentam a resposta.",
    architecture: [
      "Backend Flask — API REST com upload e Q&A",
      "CrewAI Agent — RAG configurável via YAML",
      "ChromaDB — busca vetorial persistente por sessão",
      "Gemini Vision — OCR inteligente em batch",
    ],
    tech: [
    ...
    features: [
      "Upload de múltiplos formatos (PDF, imagens, docs)",
      "OCR inteligente com Gemini Vision",
      "Busca vetorial isolada por sessão",
      "Agente RAG configurável via YAML",
      "Q&A contextual sobre documentos",
    ],
    github: "https://github.com/lharanhamg/zoox_agents",
    role: "Contribuidor ativo",
    icon: "FileSearch",
    featured: false,
    images: [
      "/projects/zoox-agents/screenshot-1.png",
      "/projects/zoox-agents/screenshot-2.png",
    ],
  },
  {
    slug: "question-resolution",
    name: "Question Resolution",
    tagline: "Pipeline automatizado de resolução de questões com IA",
    description:
      "Question Resolution é um pipeline automatizado para extração e resolução de questões de provas. O sistema utiliza OCR para digitalizar provas físicas e um agente de IA especializado para gerar respostas contextualizadas com explicações detalhadas.\n\nO backend FastAPI processa os documentos enviados, extraindo questões e alternativas via OCR. Cada questão é então processada por um agente OpenAI com contexto específico do domínio, gerando resoluções estruturadas e fundamentadas.\n\nTodos os dados são persistidos no Supabase, permitindo consultas posteriores e construção de um banco de questões resolvidas que pode ser utilizado para estudos e revisões.",
    howItWorks:
      "O documento da prova é enviado ao sistema e o motor de OCR extrai as questões, alternativas e enunciados com seus respectivos metadados (número da questão, matéria, nível de dificuldade quando disponível).\n\nCada questão extraída é processada individualmente pelo agente OpenAI, que recebe contexto específico do domínio para gerar respostas precisas. O agente não apenas indica a alternativa correta, mas fornece uma explicação passo a passo do raciocínio.\n\nAs resoluções são estruturadas e armazenadas no Supabase, acessíveis via API REST para integração com outras plataformas educacionais ou interfaces de estudo.",
    architecture: [
      "Backend FastAPI — processamento e API",
      "OpenAI — agente especializado",
      "Supabase — persistência",
      "OCR Engine — digitalização de provas",
    ],
    tech: [
      { name: "FastAPI", category: "Backend" },
      { name: "Supabase", category: "Database" },
      { name: "OpenAI", category: "AI/ML" },
      { name: "OCR", category: "AI/ML" },
      { name: "Python", category: "Backend" },
    ],
    features: [
      "Extração automática de questões via OCR",
      "Agente especializado com IA",
      "Respostas contextualizadas",
      "API REST para integração",
    ],
    github: "https://github.com/jvchaaves/question-resolution",
    role: "Desenvolvedor principal",
    icon: "FileQuestion",
    featured: false,
    images: [
      "/projects/question-resolution/screenshot-1.png",
      "/projects/question-resolution/screenshot-2.png",
    ],
  },
  {
    slug: "personal-help-agent",
    name: "Personal Help Agent",
    tagline: "Agente de busca inteligente com arquitetura RAG",
    description:
      "Personal Help Agent é um agente de busca inteligente com arquitetura RAG (Retrieval-Augmented Generation). O sistema permite consultas em linguagem natural sobre bases de dados de clientes, combinando busca vetorial com geração aumentada por recuperação.\n\nOs dados de clientes são carregados de arquivos CSV, processados em chunks e vetorizados via OpenAI Embeddings. O índice vetorial FAISS permite buscas semânticas rápidas e precisas, mesmo em grandes volumes de dados.\n\nO sistema também oferece lookup direto por identificadores como CPF e CNPJ, combinando a flexibilidade da busca semântica com a precisão de consultas estruturadas.",
    howItWorks:
      "Os dados de clientes são carregados de arquivos CSV e processados pelo Pandas. O texto é dividido em chunks otimizados e cada chunk é vetorizado utilizando OpenAI Embeddings, gerando representações semânticas densas.\n\nOs vetores são armazenados em um índice FAISS (Facebook AI Similarity Search), que permite buscas por similaridade extremamente rápidas. Quando o usuário faz uma pergunta em linguagem natural, o sistema vetoriza a query e busca os chunks mais relevantes no índice.\n\nOs chunks recuperados são passados como contexto para o LLM, que gera uma resposta natural e precisa baseada nos dados reais dos clientes. Para consultas por CPF ou CNPJ, o sistema usa lookup direto para máxima precisão.",
    architecture: [
    ...
    features: [
      ...
      "Lookup direto por CPF/CNPJ",
    ],
    github: "https://github.com/jvchaaves/personal_help_agent",
    role: "Desenvolvedor principal",
    icon: "Search",
    featured: false,
    images: [
      "/projects/personal-help-agent/screenshot-1.png",
      "/projects/personal-help-agent/screenshot-2.png",
    ],
  },
  {
    ...
    github: "https://github.com/Enilsonn/projeto_lotep",
    role: "Autor principal — 90% dos commits",
    icon: "Database",
    featured: false,
    images: [
    ...
    metrics: "90% dos commits • 18 processadores • 3 extratores",
  },
  {
    slug: "ufc-predictive-analysis",
    name: "UFC Predictive Analysis",
    tagline: "Classificação preditiva de lutadores com ML clustering",
    description:
      "UFC Predictive Analysis é um modelo de classificação preditiva para lutadores do UFC. O projeto analisa dados de 1.669 atletas e os agrupa em 5 arquétipos distintos utilizando algoritmos de clustering não-supervisionado.\n\nO pipeline de dados inclui coleta, pré-processamento e engenharia de features sobre estatísticas de luta — strikes, takedowns, submissions, controle de octógono, entre outros atributos. Os algoritmos de clustering identificam padrões naturais nos dados que correspondem a estilos de luta distintos.\n\nAs visualizações estatísticas permitem explorar as características de cada arquétipo, comparar lutadores e entender quais atributos são mais discriminativos para cada grupo. O modelo preditivo permite classificar novos lutadores nos arquétipos identificados.",
    howItWorks:
      "Os dados de lutadores do UFC são coletados e pré-processados, com tratamento de valores ausentes, normalização e encoding de variáveis categóricas. A engenharia de features extrai métricas derivadas das estatísticas brutas de luta.\n\nAlgoritmos de clustering não-supervisionado (como K-Means e DBSCAN) são aplicados sobre os features processados. A análise de silhouette e elbow method determinam o número ideal de clusters, resultando em 5 arquétipos distintos de lutadores.\n\nUm modelo de classificação supervisionada é treinado sobre os labels gerados pelo clustering, permitindo predizer o arquétipo de novos lutadores com base em suas estatísticas. Visualizações com redução de dimensionalidade (PCA/t-SNE) mostram a separação dos grupos no espaço de features.",
    architecture: [
      "Data Collection — coleta de dados de lutadores",
      "Feature Engineering — engenharia de atributos",
      "Clustering — agrupamento não-supervisionado",
      "Classificação — modelo preditivo",
    ],
    tech: [
      { name: "Python", category: "Backend" },
    ...
    features: [
      "Análise de 1.669 lutadores",
      "5 arquétipos de lutadores",
      "Clustering não-supervisionado",
      "Visualizações estatísticas",
    ],
    github: "https://github.com/jvchaaves/projeto-icd",
    role: "Desenvolvedor",
    icon: "BarChart3",
    featured: false,
    images: [
      "/projects/ufc-predictive-analysis/screenshot-1.png",
      "/projects/ufc-predictive-analysis/screenshot-2.png",
    ],
  },
];
